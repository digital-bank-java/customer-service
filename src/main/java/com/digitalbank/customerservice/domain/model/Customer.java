...
public record Customer(
    ...
    public static Customer createActive(
            ...
            Instant now) {
        return new Customer(
                id, email, mobileNumber, firstName, lastName, dateOfBirth, CustomerStatus.ACTIVE, 0L, now, now);
    }

    public Customer updateProfile(String mobileNumber, String firstName, String lastName, Instant now) {
        return new Customer(id, email, mobileNumber, firstName, lastName, dateOfBirth, status, version, createdAt, now);
    }
